    ...
    <div class="container bottom-ultra first">
        <div class="bread center">
            <div class="bread__wrapper">
                ...
                <a href="/catalog/">Все часы</a>
                <svg width="5" height="8" viewBox="0 0 5 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L4 4L1 7" stroke="#121212" />
                </svg>
                <?= $category_name ?>
            </div>
            <h2 class="bread__title uppercase"><?= $category_name ?></h2>
        </div>
...
<section class="catalog-list">
    <div class="container top-min">
        <?php 
            ...
            $GLOBALS['arrFilter']['PROPERTY_CATEGORY'] = $category_id;
            ...
            if (isset($_GET['new']) && $_GET['new'] == 'on') {
                $GLOBALS['arrFilter']['PROPERTY_NEWPRODUCT'] = 1;
            }
