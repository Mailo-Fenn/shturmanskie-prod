...
<section class="banner warranty" style="background-image: url('/images/service/service-center-banner.webp');">
        ...
        <div class="grid">
            ...
            <div class="imaged-text__image-wrapper">
                <div 
                    ...
                    style="background-image: url('/images/service/img1.webp'); background-repeat: no-repeat;"
                ></div>
            </div>
        </div>
    </div>
    ...
    <div class="container imaged-container middle-padding">
        <div class="grid">
            <div class="imaged-text__image-wrapper">
                <div 
                    class="imaged-text__image"
                    style="background-image: url('/images/service/img2.webp'); background-repeat: no-repeat;"
                ></div>
            </div>
            <div class="imaged-text__content">
                <?$APPLICATION->IncludeComponent(
