...
<?endif;
	...
	$titles = explode('#eng#', $arSeoProps["ELEMENT_META_TITLE"]);
	
	if($LENGUAGE == 'ru') {				
		$APPLICATION->SetTitle($titles[0]);
		$APPLICATION->SetPageProperty("title", $titles[0]);
		
	}
	else {		
		$APPLICATION->SetTitle($titles[1]);
		$APPLICATION->SetPageProperty("title", $titles[1]);
