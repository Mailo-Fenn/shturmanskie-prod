                                ...
                                <table align="center" border="0" cellspacing="0" cellpadding="0" class="em-mob-width-100perc">
                                    <tr>
                                        <td width="580" valign="top" class="em-mob-wrap em-mob-width-100perc">
                                            <table cellpadding="0" cellspacing="0" border="0" width="100%" class="em-mob-width-100perc" em="atom">
                                                <tr>
                                                    <td align="center">
                                                        <img src="https://<?=$_SERVER['HTTP_HOST']?>/upload/main/maillogo.png" width="300" border="0" alt="" style="display: block; width: 100%; max-width: 300px;">
														<!--<img src="https://sidwatch-ru.vh413286.eurodir.ru/images/maillogo.png" width="199" border="0" alt="" style="display: block; width: 100%; max-width: 199px;">-->
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
